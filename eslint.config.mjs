...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    ".claude/**",
    // docs/ is prose and throwaway session scratch, not source — `lint:src` means source.
    // A one-off .cjs pasted into a Context note must not fail the pre-commit hook.
    "docs/**",
