...
/**
 * Cloudflare Turnstile server-side verification — the captcha half of the registration abuse posture
 * (the shared-project quota is what it protects). The server action calls this BEFORE the Phase-3
 * signUp; a false result blocks the submission.
 *
 ...
 *
 * A deliberate small twin of the sibling contact-form verifier (slice #53): the two slices ship on
 * separate branches and this file stays byte-identical so the later stack merge auto-resolves.
 */
